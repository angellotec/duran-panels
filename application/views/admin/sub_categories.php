		...
		?>
            <div class="panel panel-default">
                <div class="panel-heading title-bar-blue" style="padding-bottom:20px;">
                    <i class="fa fa-folder mr-5"></i>Sub Categories
				</div>
								...
								<tr>
									...
									<td>
										...
										<ul class="dropdown-menu" role="menu">
											<li>
												<a href="#" style="background: transparent;" data-id="'.$subctg['id'].'" class="js-sub-cat-edit">
											...
											<li>
												...
												<button style="padding: 1px 20px;border: none;background: transparent;" type="submit" name="disable" value="'.$subctg['id'].'" id="enable'.$subctg['id'].'" data-id="'.$subctg['id'].'" class="js-user-disable">
											...
											<li>
												<form action="" method="post">
												<button style="padding: 1px 20px;border: none;background: transparent;" onclick="return confirm(\'Are you sure you want to delete the Sub Category ?\');" type="submit" name="delete" value="'.$subctg['id'].'" id="disable'.$subctg['id'].'" class="js-user-delete" data-user_name="Ajay" >
									...
									echo ' <div class="btn-group">
									   ...
									   <ul class="dropdown-menu" role="menu">
										   ...
										   <li>
											   <a href="#" data-id="'.$subctg['id'].'" class="js-sub-cat-edit"  data-toggle="modal">
											   <i class="fa fa-edit"></i> Edit 
											   </a>
										   </li>
										   ...
										   <li>
											   <form action="" method="post">
											   <button style="padding: 1px 20px;border: none;background: transparent;" type="submit" name="enable" value="'.$subctg['id'].'" id="disables'.$subctg['id'].'" data-id="'.$subctg['id'].'" class="js-user-disable">
...
<script>
	$(".js-sub-cat-edit").click(function(){
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/dashboard/edit_Subcat",
			data: "&id="+id,
