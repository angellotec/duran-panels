                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading title-bar-green" style="color:#fff;">
                            <i class="fa fa-flag mr-5"></i>premium services
                        </div>
                     ...
                     <div class="panel panel-default table-responsive" style="padding: 2%;">
                        <button type="button" class="btn-green js-our-pricing" data-toggle="modal" data-target="#updatepricing" data-id="2">
                          Edit Pricing
                        </button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header title-bar-orange">
        <h5 style="color:#fff;width:93%;float:left;font-weight: bold;" class="modal-title" id="exampleModalLabel">Update Premium Services</h5>
