	...
	<div class="row dash-icon">
		<div class="col-lg-3 col-md-6">
			<div class="panel panel-primary">
			 <a href="<?php echo base_url(); ?>panels/supermacdaddy/ondemand">
		...
		<div class="col-lg-3 col-md-6">
			<div class="panel panel-primary">
				<a href="<?php echo base_url(); ?>panels/supermacdaddy/ondemand/affiliate">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-3">
		  ...
		  <div class="col-lg-3 col-md-6">
                     <a href='<?php echo base_url(); ?>panels/supermacdaddy/ondemand/support_tickets'>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
