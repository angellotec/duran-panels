				...
				<li class="dropdown settings">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                     ...
                     <ul class="dropdown-menu dropdown-user medconnex16profile">
                        <li><a href="<?php echo base_url(); ?>panels/supermacdaddy/affiliatepartner/setting"><i class="fa fa-user fa-fw"></i>Profile</a>
                         </li>
                           <li><a href="<?php echo base_url(); ?>panels/supermacdaddy/affiliatepartner/pending_providers"><i class="fa fa-user fa-fw"></i>Pending Providers</a>
                         </li>
                         <li><a href="<?php echo base_url(); ?>panels/supermacdaddy/affiliatepartner/pending_interviews"><i class="fa fa-user fa-fw"></i>Pending Interviews</a>
                         </li>
                          <li><a href="<?php echo base_url(); ?>panels/supermacdaddy/affiliatepartner/pending_affiliate"><i class="fa fa-user fa-fw"></i>Pending Affiliates</a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>panels/supermacdaddy/affiliatepartner/logout" class="brdr-0"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-messages -->
                </li>
