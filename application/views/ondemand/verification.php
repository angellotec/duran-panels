                                ...
                                <tr class="odd gradeX" id="rejectremove_<?=$val['id']?>">
									...
									foreach ($get_query->result() as $document_view) 
									{
										...
										if (file_exists($filename)) {
											...
											<a href="javascript:void(0)" data-toggle="modal" data-target="#vefiymodal" style="text-decoration: none"> <?= $link_name[0] ?> <span class="btn btn-success btn-sm">verified</span></a>	<br>
									...
									<?php }  } } ?>
										...
										<button  type="submit" name="document_verify" value="<?php echo $val['id']; ?>" id="deactive" class="btn btn-success">
									    Verify 
										</button>
										</form> -->
									</td>
