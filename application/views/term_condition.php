        ...
        <div id="wrapper" class="toggled">
			...
			<section class="home" id="home" data-stellar-background-ratio="0.4">
                <div id="slider12">
                    ...
                    <figure>
						<?php
						$result = $this->db->query("select * from cp_banner_slider");
						$data = $result->result();
						foreach ($data as $row) {
							?>
							<img src="<?php echo base_url() . "/public/" . $row->img_url; ?>" />
						<?php } ?>
                    </figure>
                </div>
                <div class="quick-menu">
                    <p>
                        <a href="#" title="English" class="btn btn-default"><img class="btn-english" src="<?php echo base_url(); ?>public/images/USA.png" /></a>
                    </p>
                    <br>
					<p>
						<a href="#" title="Spanish" class="btn btn-default"><img class="btn-spanish" src="<?php echo base_url(); ?>public/images/mexico.png" /></a>
					</p>
					<br>
					<p>
						<?php
						...
						<?php } else { ?>
							<a href="#" title="Login" data-toggle="modal" data-target="#logindiffernt" class="btn btn-default"><i class="fa fa-lock fa-2x"></i></a>
						<?php } ?>
					</p>
					<br>
