...
$(document).ready(function(){
	...
	$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/notification",
			data: "",
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/notificationcount",
			data: "",
			success: function(response){
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/tasknotification",
			data: "",
			success: function(response)
			{
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/tasknotificationcount",
			data: "",
			success: function(response){
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/msgnotification",
			data: "",
			success: function(response)
			{
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/msgnotificationcount",
			data: "",
			success: function(response){
	...
	$(".js-user-edit").click(function(){
		...
		$.ajax({
			type: "post",
			url:"<?php echo base_url();?>panels/supermacdaddy/onsales/edit_product",
			data: "&id="+id,
			success: function(response){
