                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                ?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $store['user_name']; ?></td>
                                        <td><?php echo $store['display_name']; ?></td>
                                        <td><?php echo $store['email']; ?></td>
                                        <td class="center"><?php echo $store['title']; ?></td>
                                        <td class="center"><?php echo $store['locale']; ?></td>
                                        <td class="center"><?php echo $store['state']; ?></td>
                                        <td class="center"><?php echo $store['address']; ?></td>
                                        <td class="center"><?php echo $store['user_lat']; ?></td>
                                        <td class="center"><?php echo $store['user_long']; ?></td>
                                        <td class="center"><?php echo $store['zip']; ?></td>
                                        <td class="center"><?php echo $store['mob_number']; ?></td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
                            </table>
